...
// timestamps
// making use of the unix epoch which in January 1st 1970 at midnight
// negative values are those before the epoch
// 33400, 10, -203
...
const getVisibleExpenses = (expenses, { text, sortBy, startDate, endDate }) => {
  return expenses
    .filter(({ createdAt, description, note }) => {
...
// store testing and subscription
store.subscribe(() => {
